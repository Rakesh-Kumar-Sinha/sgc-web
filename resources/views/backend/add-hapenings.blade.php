    ...
    <div class="content">
        <div class="container-fluid">
            <div class="container">
                ...
                <form action="{{ route('happenings.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary">Add Happenings</button>
                </form>
            </div>
        </div>
    </div>
